...
public final class Constants {
    public static final String XEROX_FILTER = "[shop=copyshop]";
    public static final String RESTAURANT_FILTER = "[amenity=restaurant]";
    public static final String SERVER_URL = "http://www.overpass-api.de/api/xapi?node";
